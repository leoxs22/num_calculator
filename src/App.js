...
import {Card, Col, Container, FormControl, InputGroup, ListGroup, Row, Table} from "react-bootstrap";
                ...
                <div>
                        ...
                        <ListGroup>
                            <ListGroup.Item>
                                <Row>
                                    ...
                                    <Col className="col-auto">${formatNumber(1 / nuArsPrice)} </Col>
                                </Row>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <Row>
                                    <Col>Anchor APY</Col>
                                    <Col className="col-auto">{formatNumber(anchorAPY * 100)}% </Col>
                                </Row>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <Row>
                                    <Col>Ratio colateral</Col>
                                    <Col className="col-auto">{formatNumber(colateralRatio * 100)}%</Col>
                                </Row>
                            </ListGroup.Item>
                        </ListGroup>
                    </Card>
                    <Card className="p-3">
                        <select className="form-select mb-3" aria-label="Default select"
                            ...
                            {interests.map(interest =>
                                <option value={interest.days}
                                        selected={interest.days === selectedDays}>{interest.days} días - Tasa de
                                    descuento {interest.discount * 100}%</option>
                            )}
                        </select>
                        <InputGroup>
                        ...
                        <ListGroup>
                            <ListGroup.Item>
                                <Row>
                                    ...
                                    <Col className="col-auto">${formatNumber(amountToReceive)}</Col>
                                </Row>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <Row>
                            ...
                            <ListGroup.Item>
                                <Row>
                                    ...
                                    <Col className="col-auto">U$D {formatNumber(colateralNeeded)}</Col>
                                </Row>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <Row>
                                    <Col>Ganancia en Anchor</Col>
                                    <Col className="col-auto">U$D {formatNumber(expectedAnchorEarnings)}</Col>
                                </Row>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <Row>
                                    <Col>Ganancia en Anchor <span
                                        className={"text-muted"}>sin colateral extra</span></Col>
                                    <Col
                                        className="col-auto">U$D {formatNumber(expectedAnchorEarningsWithoutColateral)}</Col>
                                </Row>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <Row>
                                    <Col>Precio del dólar al que se paga solo</Col>
                                    <Col className="col-auto">$ {formatNumber(dolarPriceNeededToCoverInterest)}</Col>
                                </Row>
                            </ListGroup.Item>
                            <ListGroup.Item>
                                <Row>
                                    ...
                                    <Col className="col-auto">
                                        <p className={"mb-0"}>
                                            <div className={"float-right"}>
                                                ...
                                                {formatNumber((((requiredDolarIncrease + 1) ** (30 / selectedDays)) - 1) * 100)}%
                                            </div>
                                        </p>
                                        <p className={"mb-0"}>
                                            <div className={" float-right"}>
                                                <span className={"text-muted"}> en {selectedDays} días </span>
                                        ...
                                        <p className={"mb-0"}>
                                            <div className={"float-right"}>
                                                ...
                                                {formatNumber((((requiredDolarIncrease + 1) ** (365 / selectedDays) - 1) * 100))}%
                                            </div>
                                        </p>
                                    </Col>
                                </Row>
                    ...
                    <Card>
                        <div className={"text-center p-1"}>
                            ...
                            <a href={"http://twitter.narosky.com"} target="_blank" className={"px-1"}><FaTwitter/></a>
                            <a href={"http://linkedin.narosky.com"} target="_blank"
                               className={"px-1"}><FaLinkedinIn/></a>
                            <a href={"http://github.narosky.com"} target="_blank" className={"px-1"}><FaGithub/></a>
                        </div>
                    </Card>
                    <Card className={"p-2"}>
                        <div className={"text-muted"}>Intereses de num actualizados al 22/04/2022</div>
                        <div className={"text-muted"}>Puede haber errores en los cálculos, do your own research</div>
                    </Card>
                </div>
            </Container>
        </div>
